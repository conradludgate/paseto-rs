...
#[cfg(feature = "encrypting")]
impl paseto_core::version::SealingVersion<Local> for V5 {
...
impl paseto_core::version::UnsealingVersion<Local> for V5 {
    type Nonce = [u8; 32];
    type Tag = [u8; 48];
